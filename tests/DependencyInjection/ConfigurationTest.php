...
use Setono\SyliusNavigationPlugin\DependencyInjection\Configuration;
...
final class ConfigurationTest extends TestCase
{
    ...
    public function values_are_invalid_if_required_value_is_not_provided(): void
    {
        $this->assertConfigurationIsInvalid(
            ...
            '/The child (config|node) "option" (under|at path) "setono_sylius_navigation" must be configured/',
            true,
        );
    }
